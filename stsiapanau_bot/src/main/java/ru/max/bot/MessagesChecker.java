									...
									for (int i = 0; i < resultSize; i++) {
										...
										try {
											...
											try {
												...
												JSONArray entities = message
														.getJSONArray("entities");

												typeCommand = entities
														.getJSONObject(0)
														.getString("type");
											...
											if (typeCommand
												...
												case "/ada":
													answer = new StringBuilder()
															...
															.append("/setevents - activate adding event mode. After you must send two simple messages: 1- event name; 2- description and etc.\n")
															.append("/save - saved all added events\n")
															.append("/delone event_name - removed event by name\n")
												...
												default: {
													...
													if (text.contains("calc")) {
														...
														if (checkStrByRegexp(
															...
															Optional<String> answerTemp = (rentHolder != null) ? Optional.of(String
																	.valueOf(rentHolder
																			.get()
																			.getTotal(
																					outfall)))
